          ...
          <Form floated='left'>
            <Form.Group inline>
              ...
              <Form.Field
                ...
                value='toshelf'
                checked={this.props.filterByStatus === 'toshelf'}
                onChange={this.handleChange}            
              />
              <Form.Field
                control={Radio}
                label='Drafts Good to Revise'
                value='goodtorevise'
                checked={this.props.filterByStatus === 'goodtorevise'}
                onChange={this.handleChange}            
              />
              <Form.Field
                control={Radio}
                label='Drafts Revised'
                value='readytoupload'
                checked={this.props.filterByStatus === 'readytoupload'}
                onChange={this.handleChange}            
              />
              <Form.Field
                control={Radio}
